...
},{"./eval":9}],4:[function(require,module,exports){
const {
  parseExpression, 
  evalExpression,
} = require('./eval');
...
class Map {
  ...
  configure(config) {
    ...
    if (template !== undefined) {
      ...
      this._properties = Object.keys(template).reduce(
        (all, cur) => {
  ...
  process(params) {
    const mapper = x => {
      ...
      try {
        ...
        const initial = this.mode === 'replace' ? 
...
},{"./eval":9}],5:[function(require,module,exports){
...
class MatchFilter {
  ...
  process(params) {
    if (this.filterByTerms) {
      const match = this.filterByTerms.find(term => params.indexOf(term) !== -1);
      if (match) {
        return null;
      }
    }
...
class Reduce {
  ...
  configure(config) {
    ...
    if (initialState !== undefined) {
      ...
      this.app.notify(this, { initialState });
    }
...
},{"./eval":9}],8:[function(require,module,exports){
...
class Timer {
  ...
  configure(config) {
    ...
    const process = () => {
      if (this.conditionUntilTriggercount &&
          this.count > this.conditionUntilTriggercount) {
            this.clearTimer();
      } else {
        this.app.next(this, this.nextTimerArgument());
      }
    };
    ...
    if (doStart) {
      if (this.periodic) {
        this.clearTimer();
        const timeBetween = moment.duration(this.periodicValue, this.periodicUnit);
  ...
  nextTimerArgument(params = {}) {
    return { ...params, triggerCount: ++this.count };
  }
  ...
  async process(params) {
    ...
    if (this.isSleeping) {
      console.warn('Processing timer service while sleeping ... process dropped')
    ...
    return this.nextTimerArgument(params);
  }
}
...
},{"./helpers":10,"moment":14,"timers":16}],9:[function(require,module,exports){
const { parse, eval: expEval } = require('expression-eval');
const moment = require('moment');

function evilEval(f, params) {
  const script = `'use strict'; const params=${JSON.stringify(params)}; return (${f})`;
...
},{"expression-eval":12,"moment":14}],10:[function(require,module,exports){
function sleep(t) {
...
function createServiceFactory(rt, descriptor) {
  ...
  return {
    serviceId,
    serviceName,
    create: (board, descriptor, id) =>
      new Service(rt, board, descriptor, id)
  };
}
...
},{"./Batcher":1,"./Buffer":2,"./Filter":3,"./Map":4,"./MatchFilter":5,"./Monitor":6,"./Reduce":7,"./Timer":8,"./eval":9}],12:[function(require,module,exports){
...
},{"jsep":13}],13:[function(require,module,exports){
...
},{"process/browser.js":15,"timers":16}]},{},[11])(11)
});
